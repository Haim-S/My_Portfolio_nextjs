...
const MY_PROJECTS = [
    ...
    {id: 5, img: "/../public/assets/projects/shosStore.png", titleName: "Shos Store", titleFramework: "JS / Bootstrap / MongoDB", about: "A vanilla application, which also has security by token, and there is a normal user difference that has normal possibilities to differentiate administrator options.", githubUrl: "https://github.com/Haim-S/OKD/tree/version_1", diployUrl: null, Technologies: ["Javascript", "Bootstrap", "Tokens"]},
]
