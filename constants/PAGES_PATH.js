...
const MY_PROJECTS = [
    ...
    {id: 5, img: "/public/assets/projects/shosStore.png", titleName: "Shos Store", titleFramework: "JS / Bootstrap / MongoDB", about: "A vanilla application, which also has security token, and there is difference between normal user options and administrator options", githubUrl: "https://github.com/Haim-S/OKD/tree/version_1", diployUrl: null, Technologies: ["Javascript", "Bootstrap", "Tokens"]},
]
